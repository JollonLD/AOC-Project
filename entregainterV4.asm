...
locais: .asciiz "1. Parque Vicentina Aranha\n2. DCTA - Instituto de Aeronáutica\n3. Shopping Colinas\n4. Observatorio Astronomico\n"

transportes: .asciiz "\nMeios de transporte disponiveis:\n1. Carro\n2. Onibus\n3. Bicicleta\n4. A pe\n"

# Distancia em km (56 x 56)
distancias:   .word 0, 2, 3, 0    # distancia do local 1
              .word 0, 0, 7, 5    # distancia do local 2
              .word 0, 0, 0, 8    # distancia do local 3
              .word 0, 0, 0, 0    # distancia do local 4
...
caminho: .word 0:56          # Array para armazenar o caminho atual (max 10 vertices)
...
saida_tempo: .asciiz "\nTempo estimado em minutos: "
sem_caminho: .asciiz "Caminho não encontrado\n"
tchau: .asciiz "\nAté a próxima vez!\n"
...
input_transporte:
    ...
    # Verificar se algum caminho foi encontrado
    la $t0, contador_caminhos
    lw $t1, ($t0)
    beqz $t1, caminho_nao_encontrado  # Se contador_caminhos == 0, não encontrou caminho
